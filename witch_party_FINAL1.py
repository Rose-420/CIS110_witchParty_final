...
while goAgain.lower() == "y":
    ...
    while witchAge.isalpha():
        witchAge = input("\nYou entered letters. Please enter a numeric value:  ")
    ...
    while witchFamiliar_name.isnumeric():
